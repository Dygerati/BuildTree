...
var _BuildTree = _interopRequireDefault(__webpack_require__(5));
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          ...
          instance = new _BuildTree["default"]({
...
function () {
  ...
  function BuildTree(_ref) {
    ...
    (0, _classCallCheck2["default"])(this, BuildTree);
    (0, _defineProperty2["default"])(this, "config", {});
    (0, _defineProperty2["default"])(this, "treeDepth", 0);
    console.info("Initializing with filelist at ".concat(filelist, " && selector ").concat(selector));
  ...
  (0, _createClass2["default"])(BuildTree, [{
    key: "sortByName",
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return this.fetchFileList() // Converting filelist into usable data structure
                .then(this.generateDataMap) // Utilizing generated tree to create DOM elements, recursively
                .then(function (map) {
                  return _this.createDomTree({
                    name: '',
                    children: map
                  });
                ...
                .then(function (tree) {
                  ...
                  document.querySelector(_this.config.root).appendChild(tree);
                }) // Ensures the widths for each generated tree column line up
                .then(this.normalizeWidths.bind(this));

              case 3:
                console.info("Created tree of depth ".concat(this.treeDepth));
                _context.next = 10;
                break;
              ...
              case 6:
                ...
                console.warn('Encountered error while building tree:', _context.t0.message);
                document.body.innerHTML = "<p>Unable to create tree for file list at ".concat(this.config.filelist, "</p>");
    ...
    key: "normalizeWidths",
    value: function normalizeWidths() {
      var _loop = function _loop(i) {
        // Retrieve all nodes in level
        var nodes = document.querySelectorAll(".level-".concat(i));
        var nodeList = Array.from(nodes); // Determine the maximum width for all nodes

        var maxWidth = nodeList.reduce(function (max, curr) {
          return curr.clientWidth > max ? curr.clientWidth : max;
        }, 0); // Set each node to max width
    ...
    key: "createDomTree",
    value: function createDomTree(root) {
      ...
      title.appendChild(document.createTextNode("".concat(root.name).concat(root.children.length ? '/' : ''))); // Add classes for label

      titleContainer.classList.add('tree-label', "level-".concat(level));
      titleContainer.appendChild(title); // Assemble into parent

      parent.appendChild(titleContainer);
      parent.classList.add('tree-parent'); // If node has children, trigger recursively generating child nodes

      if (root.children.length) {
        // Create element for children and sort by names
        var childContainer = document.createElement('div');
        var childrenSorted = root.children.sort(this.sortByName);
        childContainer.classList.add('tree-children'); // Trigger this function for each child, appending markup to container
        ...
        try {
          for (var _iterator = childrenSorted[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
    ...
    key: "generateDataMap",
    value: function generateDataMap(files) {
      var tree = [];
      var wrapper = {
        tree: tree
      ...
      files.split('\n').forEach(function (path) {
        ...
        path.split('/').reduce(function (map, name) {
    ...
    key: "fetchFileList",
    value: function () {
      var _fetchFileList = (0, _asyncToGenerator2["default"])(
      /*#__PURE__*/
        ...
        return _regenerator["default"].wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.prev = 0;
                return _context2.abrupt("return", fetch(this.config.filelist, {}).then(function (res) {
                  return res.text();
                }));
      ...
      function fetchFileList() {
        return _fetchFileList.apply(this, arguments);
      }
